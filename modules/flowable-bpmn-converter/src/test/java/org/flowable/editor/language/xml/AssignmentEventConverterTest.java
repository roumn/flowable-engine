 ...
 * @author Roman Saratz
 */
class AssignmentEventConverterTest {

    @BpmnXmlConverterTest("assignmentlistenertest.bpmn")
    void validateModel(BpmnModel model) {
        FlowElement flowElement = model.getFlowElement("boundaryEvent1");
        ...
        assertThat(eventDefinition).isInstanceOf(AssignmentEventDefinition.class);
    }
}
